            ...
            messages=[
                {
                    ...
                    NEVER write generic news. Use the provided context to write 3 short social media posts.
                    
                    CRITICAL RULES:
                    - Do not include numbers, titles, or persona labels.
                    - Only give me the exact text to post.
                    - Max 280 chars, 1-2 emojis, 1 hashtag per post.
